...
<InfoCard
title="Résumé"
value={trip.summary || "Résumé non disponible."}
icon="✦"
/>
<InfoCard
title="Meilleure période"
value={trip.bestPeriod || "Non précisée"}
icon="☀️"
/>
<InfoCard
title="Villes"
...
{hotel.priceRange || "Tarif non précisé"}
</div>
...
{restaurant.tip ? (
<p style={styles.smallMuted}>💡 {restaurant.tip}</p>
) : null}
</div>
))}
</div>
...
Itinéraire, hôtels, restaurants et aperçu général.
</div>
</div>
</section>
...
{trip.country || "Guide premium"}
</div>
<h2 style={styles.tripTitle}>
{trip.destination || destination}
</h2>
<p style={styles.tripSummary}>
{trip.summary || "Résumé non disponible."}
</p>
</div>
